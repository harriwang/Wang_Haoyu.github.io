...
<button id="see-more-btn" class="btn btn-primary" onclick="document.getElementById('hidden-items').style.display='block'; this.style.display='none';">Expand</button>

<button id="see-less-btn" class="btn btn-primary" onclick="document.getElementById('hidden-items').style.display='none'; document.getElementById('see-more-btn').style.display='block';">Collapse</button>
